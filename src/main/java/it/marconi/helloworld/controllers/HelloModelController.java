...
public class HelloModelController {
    ...
    @GetMapping("/{fuckingUsername}")
    public ModelAndView greetPlaceholder(@PathVariable("fuckingUsername") String NomeNdoGulo){
        return new ModelAndView("hello-world-username").addObject("fuckingUsername", NomeNdoGulo);
    }
}
